        ...
        <template>
            <div v-if="openProfile" class="absolute z-50 flex flex-col w-40 py-2 px-1 mt-2 overflow-auto bg-white rounded-xl max-h-28 sm:max-h-36">
                <div class="relative flex hover:bg-gray-200 focus:bg-gray-400 rounded-md">
                    ...
                    <img src="~/assets/profile-logo.svg" alt="" class="h-4 absolute mt-1.5 ml-14 cursor-pointer" @click="$router.push('/user/account/profile')">
                </div>
                <div class="relative flex hover:bg-gray-200 focus:bg-gray-400 rounded-md">
                    ...
                    <img src="~/assets/friends-logo.svg" alt="" class="h-4 absolute mt-1.5 ml-16 cursor-pointer" @click="$router.push('/user/friends')">
                </div>
                <div class="relative flex hover:bg-gray-200 focus:bg-gray-400 rounded-md">
                    ...
                    <img src="~/assets/heart-logo.svg" alt="" class="h-4 absolute mt-1.5 ml-12 cursor-pointer" @click="$router.push('/user/liked')">
                </div>
                <div class="relative flex hover:bg-gray-200 focus:bg-gray-400 rounded-md">
                    ...
                    <img src="~/assets/bookmark-logo.svg" alt="" class="h-4 absolute mt-1.5 ml-24 pl-1.5 cursor-pointer" @click="$router.push('/user/bookmarked')">
                </div>
                <div class="relative flex hover:bg-gray-200 focus:bg-gray-400 rounded-md">
                    ...
                    <img src="~/assets/gear-logo.svg" alt="" class="h-4 absolute mt-1.5 ml-16 pl-1 cursor-pointer" @click="$router.push('/user/bookmarked')">
                </div>
